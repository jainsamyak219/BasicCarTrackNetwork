...
presetup(){
    ...
    pushd ./artifacts/src/github.com/
    go mod init
    go mod tidy
...
VERSION="1"
CC_SRC_PATH="./artifacts/src/github.com/"
CC_NAME="TrackCar"
...
chaincodeInvoke(){
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA $PEER_CONN_PARMS  \
        -c '{"function": "ManufactureCar","Args":["111","Volvo","Passat","WHITE","Max-Min","Created"]}'
...
chaincodeQuery(){
    ...
    # Query all Cars
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"Args":["QueryCarState","111"]}'
...
#         --tlsRootCertFiles $PEER0_ORG1_CA \
#         --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA $PEER_CONN_PARMS  \
#         -c '{"function": "ManufactureToDealer","Args":["111"]}'
...
#         --tlsRootCertFiles $PEER0_ORG1_CA \
#         --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA $PEER_CONN_PARMS  \
#         -c '{"function": "DealerToCustomer","Args":["111","Samyak"]}'
